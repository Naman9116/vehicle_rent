...
<HEAD>
	...
	<script src= "<%=request.getContextPath()%>/js/com/toursTravels/tJobWorks.js"></script>
		...
		<legend><strong>${jobType} Jobs</strong></legend>
			...
			<c:if test="${jobType=='Current'}">
				...
				<tr>
					...
					<td width=8%><label>Branch</label></td>
					<td width=10%>
						<select class="form-control" id="branch" style="width:100%" onChange="fillHub()">
							<option value="0">ALL</option>
   		...
   		<div class="modal-content">
   			...
   			<div class="modal-body" id="editDetailRecordPanel_body">
				...
				<div class="row">
					...
					<div class="col-md-5"><select class="form-control" id="companyName" style="width:100%">
							<option value="0">---Select---</option>
							<c:forEach var="customerOrCompanyNameId" items="${companyIdList}">
				...
				<div class="row">
					...
					<div class="col-md-5">
						<input type="text" id="bookedBy" name="bookedBy"" class="form-control" disabled="disabled"/>
					</div>
					<div class="col-md-1"></div>
				</div> 
				...
				<div class="row">
					...
					<div class="col-md-5"><input type="text" id="mobileNo" name="mobileNo" class="form-control" onblur="fillMobile();"/></div>
					<div class="col-md-1"><input type="text" id="company" name="company" style="display:none" class="form-control"/></div>
				</div>   			
						  			
   			
				<div class="row">
					<div class="col-md-1"></div>
					<div class="col-md-5"><label>Booked For</label></div>
					<div class="col-md-5">
						<input type="text" id="bookedFor" name="bookedFor"" class="form-control"/>
					</div>
					<div class="col-md-1"></div>
				</div>   		
				...
				<div class="row">
					<div class="col-md-1"></div>
					<div class="col-md-5"><label>Reporting Address</label></div>
					<div class="col-md-5"><input type="text" id="reportingAddress" name="reportingAddress" class="form-control"/></div>
					<div class="col-md-1"></div>
				</div>   	
   		...
   		<div class="modal-content">
       		...
       		<div class="modal-body" id="dispatchDetailRecordPanel_body">
				...
				<div class="row">
				    ...
				    <div class="col-md-2" id="allocateRadioDiv" style="display:none;"></div>
					<div class="col-md-1"></div>
				</div>   
