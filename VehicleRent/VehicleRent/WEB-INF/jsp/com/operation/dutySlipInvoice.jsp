...
<HEAD>
	...
	<script src= "<%=request.getContextPath()%>/js/com/operation/dutySlipInvoice.js"></script>
	<style>
	</style>
	 <script>
	...
	function onLoadPage(){
		...
		$('#dataTable2').html("${dutySlipInvoiceDataList}");
		altRows('dataTable');
	}
			...
			<tr valign="top">
				...
				<td width='10%'>
					<div class="form-group">				
						...
						<input type="button" id="searchButton" value="Retrive" onclick="getDutySlipData_DutySlipInvoice()" style="width:100%" />
					</div>
				</td>	
				<td width='8%'>
					<div class="form-group">				
