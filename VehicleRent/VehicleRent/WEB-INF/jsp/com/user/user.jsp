			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<tr height='35px'>
						...
						<td><form:input path="userFirstName" class="form-control" onkeypress="isAlphabatic(event)" maxlength="50"></form:input></td>
						<td><form:label path="userLastName" >Last Name</form:label></td>
						<td><form:input path="userLastName" class="form-control" onkeypress="isAlphabatic(event)" maxlength="50"></form:input></td>
