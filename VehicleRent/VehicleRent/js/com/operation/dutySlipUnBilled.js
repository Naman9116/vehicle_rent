	...
	function getNextPageData(){
		...
		getDutySlipData_DutySlipUnBilled();
	}
	...
	function saveOrUpdateDutySlipUnBilled() {
		var dutySlipId="";
		var receivedBy="";
        ...
        $("#addButton").attr("disabled", true);
	  	$.ajax({  
		    type: "POST",  	
		    url:  ctx + "/saveOrUpdateDutySlipUnBilled.html",  
	...
	function getDutySlipData_DutySlipUnBilled(){
		var searchCriteria=$('#corporate').val()+","+$('#bookedBy').val()+","+$('#usedBy').val()+","+$('#closedBy').val()+","+$('#hub').val();
	  	$.ajax({  
		    type: "POST",  	
		    url:  ctx + "/getDutySlipData_DutySlipUnBilled.html",  
